    ...
    if __name__=='__main__':    
        while run==1:   
            ...
            if "who made you" in statement or "who created you" in statement or "who discovered you" in statement:
                speak("I was built by Sachin Maurya ")
...
def change_name_window():   
      ...
      settings_screen.iconbitmap('app icon.ico') 
...
def info():
  ...
  info_screen.geometry("300x300")
  info_screen.iconbitmap('app icon.ico')

  creator_label = Label(info_screen,text = "Created by Sachin Maurya")
  creator_label.pack()

  Age_label = Label(info_screen, text= " at the age of 20")
  Age_label.pack()

  for_label = Label(info_screen, text = "It is programmed to perform minor tasks")
  for_label.pack()
...
def wikipedia_screen(text):
  ...
  wikipedia_screen.iconbitmap('app icon.ico')     
...
def main_screen():  
      ...
      screen.iconbitmap('app icon.ico')  


      name_label = Label(text = name_assistant,width = 300, bg = "black", fg="Yellow", font = ("Calibri", 13))
      name_label.pack()

      microphone_photo = PhotoImage(file = "Assistant logo.png")
      ...
      info_button = Button(text ="Info", bg = "white" , width=25, height =2, command = info) 
